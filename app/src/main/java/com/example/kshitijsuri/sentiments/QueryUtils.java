...
public class QueryUtils {
    ...
    public static String fetchNewsData(String requestUrl, String data) {
        URL url = createUrl(requestUrl);

        String response = null;
        try {
            response = makeHttpRequest(url,data);
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private static String makeHttpRequest(URL url, String msg) throws IOException {
        String jsonResponse = "";
